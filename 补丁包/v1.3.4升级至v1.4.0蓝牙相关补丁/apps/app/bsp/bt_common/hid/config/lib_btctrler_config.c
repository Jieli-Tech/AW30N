...
#define SET_SLAVE_ROLS_CFG   (LE_ADV | LE_SLAVE | LE_SCAN)
#else
...
#if CONFIG_SLAVE_ADD_LE_SCAN
const int config_btctler_le_hw_nums = 2;//CONFIG_BT_GATT_CONNECTION_NUM;
const int config_btctler_le_rx_nums = 9;//(CONFIG_BT_GATT_CONNECTION_NUM * 3) + 2;
#else
