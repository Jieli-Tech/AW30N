...
#if (TCFG_USER_BLE_ENABLE && TRANS_DATA_HID_EN)
...
#if CONFIG_DEBUG_ENABLE//LE_DEBUG_PRINT_EN
...
static int (*le_hogp_output_callback)(u8 *buffer, u16 size) = NULL;
static int (*le_hogp_audio_output_callback)(u8 *buffer, u16 size) = NULL;
//------------------------------------------------------
...
static sm_cfg_t hogp_sm_init_config = {
...
gatt_server_cfg_t hogp_server_init_cfg = {
...
static void __ble_bt_evnet_post(u32 arg_type, u8 priv_event, u8 *args, u32 value)
{
    ...
    init_intent(&it);
    it.name = "hid_key";
    main_application_operation_event((char *)it.name, sizeof(it.name), NULL, &e);
#else
    struct sys_event e;
    e.type = SYS_BT_EVENT;
    e.arg  = (void *)arg_type;
 ...
 */
/*************************************************************************************************/
static const u16 change_handle_table[2] = {ATT_CHARACTERISTIC_HID_2a4b_01_VALUE_HANDLE, ATT_CHARACTERISTIC_HID_2a4b_01_VALUE_HANDLE};
static void __check_report_map_change(void)
{
#if 0 //部分手机不支持
    if (hid_report_change && first_pair_flag && ble_gatt_server_characteristic_ccc_get(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a05_01_CLIENT_CONFIGURATION_HANDLE)) {
        log_info("###send services changed\n");
        ble_comm_att_send_data(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a05_01_VALUE_HANDLE, change_handle_table, 4, ATT_OP_INDICATE);
        hid_report_change = 0;
    }
#endif
}
...
static void __hogp_resume_all_ccc_enable(u8 update_request)
{
    ...
    ble_gatt_server_characteristic_ccc_set(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a4d_01_CLIENT_CONFIGURATION_HANDLE, ATT_OP_NOTIFY);
    ble_gatt_server_characteristic_ccc_set(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a4d_02_CLIENT_CONFIGURATION_HANDLE, ATT_OP_NOTIFY);
    ble_gatt_server_characteristic_ccc_set(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a4d_04_CLIENT_CONFIGURATION_HANDLE, ATT_OP_NOTIFY);
    ble_gatt_server_characteristic_ccc_set(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a4d_05_CLIENT_CONFIGURATION_HANDLE, ATT_OP_NOTIFY);
    ble_gatt_server_characteristic_ccc_set(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a4d_06_CLIENT_CONFIGURATION_HANDLE, ATT_OP_NOTIFY);
    ble_gatt_server_characteristic_ccc_set(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a4d_07_CLIENT_CONFIGURATION_HANDLE, ATT_OP_NOTIFY);
    ble_gatt_server_characteristic_ccc_set(hogp_con_handle, ATT_CHARACTERISTIC_HID_ae42_01_CLIENT_CONFIGURATION_HANDLE, ATT_OP_NOTIFY);
    ble_gatt_server_characteristic_ccc_set(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a19_01_CLIENT_CONFIGURATION_HANDLE, ATT_OP_NOTIFY);

#if RCSP_BTMATE_EN
    /* ble_gatt_server_characteristic_ccc_set(hogp_con_handle, ATT_CHARACTERISTIC_HID_ae02_01_CLIENT_CONFIGURATION_HANDLE, ATT_OP_NOTIFY); */
    /* ble_gatt_server_set_update_send(hogp_con_handle, ATT_CHARACTERISTIC_HID_ae02_01_VALUE_HANDLE, ATT_OP_AUTO_READ_CCC); */
...
static int hogp_event_packet_handler(int event, u8 *packet, u16 size, u8 *ext_param)
{
    ...
    case GATT_COMM_EVENT_CONNECTION_COMPLETE:
        ...
        hogp_connection_update_enable = 1;//TODO 均更新下
        ...
        if (ble_hid_timer_handle) {
            ...
            sys_timer_modify(ble_hid_timer_handle, (u32)(little_endian_read_16(ext_param, 14 + 0) * 1.25));
        }
    ...
    case GATT_COMM_EVENT_ENCRYPTION_CHANGE:
        ...
        if (packet[3] == LINK_ENCRYPTION_RECONNECT) {
            ...
            __ble_state_to_user(BLE_ST_NOTIFY_IDICATE, hogp_con_handle);
        }
        break;
...
static uint16_t hogp_att_read_callback(hci_con_handle_t connection_handle, uint16_t att_handle, uint16_t offset, uint8_t *buffer, uint16_t buffer_size)
{
    ...
    switch (handle) {
    case ATT_CHARACTERISTIC_HID_2a00_01_VALUE_HANDLE: {
        char *gap_name = (char *)ble_comm_get_gap_name();
    ...
    case ATT_CHARACTERISTIC_HID_2a01_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a04_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a29_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a24_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a25_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a27_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a26_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a28_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a23_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a50_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a19_01_VALUE_HANDLE:
        att_value_len = 1;
        if (buffer) {
    ...
    case ATT_CHARACTERISTIC_HID_2a4b_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a4a_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_ae10_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_2a05_01_CLIENT_CONFIGURATION_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a19_01_CLIENT_CONFIGURATION_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_01_CLIENT_CONFIGURATION_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_02_CLIENT_CONFIGURATION_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_04_CLIENT_CONFIGURATION_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_05_CLIENT_CONFIGURATION_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_06_CLIENT_CONFIGURATION_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_07_CLIENT_CONFIGURATION_HANDLE:
    case ATT_CHARACTERISTIC_HID_ae42_01_CLIENT_CONFIGURATION_HANDLE:
        if (buffer) {
...
static int hogp_att_write_callback(hci_con_handle_t connection_handle, uint16_t att_handle, uint16_t transaction_mode, uint16_t offset, uint8_t *buffer, uint16_t buffer_size)
{
    ...
    case ATT_CHARACTERISTIC_HID_2a4d_01_VALUE_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_02_VALUE_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_03_VALUE_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_04_VALUE_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_05_VALUE_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_06_VALUE_HANDLE:
    case ATT_CHARACTERISTIC_HID_2a4d_07_VALUE_HANDLE:
        vble_slave_receive(handle, buffer, buffer_size);
        break;
#if 0
    case ATT_CHARACTERISTIC_HID_2a4d_03_VALUE_HANDLE:
        printf_buf(buffer, buffer_size);           //键盘led灯状态
    ...
    case ATT_CHARACTERISTIC_HID_2a4d_07_VALUE_HANDLE:
        ...
        if (le_hogp_audio_output_callback) {
            le_hogp_audio_output_callback(buffer, buffer_size);
        }
        break;
#endif
...
#if RCSP_BTMATE_EN
    case ATT_CHARACTERISTIC_HID_ae02_01_CLIENT_CONFIGURATION_HANDLE:
        ble_gatt_server_set_update_send(connection_handle, ATT_CHARACTERISTIC_HID_ae02_01_VALUE_HANDLE, ATT_OP_AUTO_READ_CCC);
    ...
    case ATT_CHARACTERISTIC_HID_2a19_01_CLIENT_CONFIGURATION_HANDLE:
        ...
        if (handle == ATT_CHARACTERISTIC_HID_ae02_01_CLIENT_CONFIGURATION_HANDLE) {
            u8 data[1] = {0xff};
            ble_comm_att_send_data(connection_handle, ATT_CHARACTERISTIC_HID_ae02_01_VALUE_HANDLE, (u8 *)data, 1, ATT_OP_NOTIFY);
        }
#endif
...
#if RCSP_BTMATE_EN
    case ATT_CHARACTERISTIC_HID_ae01_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_ae41_01_VALUE_HANDLE:
    ...
    case ATT_CHARACTERISTIC_HID_ae10_01_VALUE_HANDLE:
        ...
        log_info("cur_state:");
        printf_buf(hid_information1, tmp16);

        memcpy((void *)&hid_information1[offset], buffer, buffer_size);

        log_info("new_state:");
        printf_buf(hid_information1, tmp16);
        ble_hid_transfer_channel_recieve1((u8 *)hid_information1, tmp16);
        break;
...
static void wait_to_open_adv(void *p)
{
    if (!hogp_con_handle) {
...
static void __hogp_reconnect_low_timeout_handle(void *p)
{
...
static void hogp_adv_config_set(void)
{
    ...
    if (PAIR_RECONNECT_ADV_EN && hogp_pair_info.pair_flag && hogp_pair_info.direct_adv_cnt) {
        ...
        printf_buf(hogp_server_adv_config.direct_address_info, 7);
...
static void hid_battery_timer_handler(void *priev)
{
    ...
    if (hogp_con_handle && get_vbat_percent_call) {
        ...
        if (hid_battery_level != tmp_val) {
            ...
            if (ble_gatt_server_characteristic_ccc_get(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a19_01_CLIENT_CONFIGURATION_HANDLE)) {
                log_info("notify battery: %d\n", hid_battery_level);
                ble_comm_att_send_data(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a19_01_VALUE_HANDLE, &hid_battery_level, 1, ATT_OP_AUTO_READ_CCC);
            }
        }
    }
...
void bt_ble_init(void)
{
    ...
    extern void only_scan_ble_init(void);
    only_scan_ble_init();
#endif
...
void bt_ble_exit(void)
{
    log_info("***** ble_exit******\n");
    if (ble_hid_timer_handle) {
        sys_timer_del(ble_hid_timer_handle);
 ...
 */
/*************************************************************************************************/
void le_hogp_regiest_get_battery(u16(*get_battery_cbk)(void))
{
...
int ble_hid_transfer_channel_send(u8 *packet, u16 size)
{
    ...
    return ble_comm_att_send_data(hogp_con_handle, ATT_CHARACTERISTIC_HID_ae42_01_VALUE_HANDLE, packet, size, ATT_OP_AUTO_READ_CCC);
}
...
int ble_hid_transfer_channel_send1(u8 *packet, u16 size)
{
    /* log_info("transfer_tx(%d):", size); */
    /* log_info_hexdump(packet, size); */
    return ble_comm_att_send_data(hogp_con_handle, ATT_CHARACTERISTIC_HID_ae10_01_VALUE_HANDLE, packet, size, ATT_OP_AUTO_READ_CCC);
}
...
/*************************************************************************************************/
/*!
 *  \brief      不开gatt client时直接获取adv report
 *
 *  \param      [in]
 *
 *  \return
 ...
 */
/*************************************************************************************************/
void get_gap_event_advertising_report(adv_report_t *report_pt, u16 len)
{
#if CONFIG_SLAVE_ADD_LE_SCAN
    extern void ble_rx_report_handle(adv_report_t *report_pt, uint16_t len);
    ble_rx_report_handle(report_pt, len);
#endif
}
...
{
    return ble_comm_att_send_data(hogp_con_handle, ATT_CHARACTERISTIC_HID_2a4d_07_VALUE_HANDLE, data, len, ATT_OP_AUTO_READ_CCC);
}
/* 接收音频数据 */
void app_ble_recv_callback_register(int (*callback_func)(u8 *, u16))
{
    local_irq_disable();
    le_hogp_audio_output_callback = callback_func;
    local_irq_enable();
}
#endif
#endif
