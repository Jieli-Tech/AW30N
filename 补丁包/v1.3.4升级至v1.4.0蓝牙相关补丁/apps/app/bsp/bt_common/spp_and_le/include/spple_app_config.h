...
#define CONFIG_BLE_CONNECT_SLOT            0 //no support
...
#undef CONFIG_IOT_ENABLE
#define CONFIG_IOT_ENABLE                  0

//手机ota升级关闭
#undef CONFIG_APP_OTA_EN
...
#define BT_NV_RAM_SIZE                    (0x600)  //bt nv malloc堆的大小
#undef CONFIG_IOT_ENABLE
#define CONFIG_IOT_ENABLE                  0
