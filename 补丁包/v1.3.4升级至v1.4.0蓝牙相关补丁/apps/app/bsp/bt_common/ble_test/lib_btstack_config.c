...
const char log_tag_const_i_PADVB_RX AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(1);
const char log_tag_const_e_PADVB_RX AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(1);

const char log_tag_const_i_PADVB_TX AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(1);
const char log_tag_const_e_PADVB_TX AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(1);
