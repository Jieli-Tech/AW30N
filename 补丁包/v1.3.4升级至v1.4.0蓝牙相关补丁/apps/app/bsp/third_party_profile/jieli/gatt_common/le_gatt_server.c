...
void ble_gatt_server_passkey_input(u32 *key, u16 conn_handle)
{
    ...
    *key = 123456; //default key
    ...
    __gatt_server_event_callback_handler(GATT_COMM_EVENT_SM_PASSKEY_INPUT, (u8 *)tmp_val, 6, 0);
...
void ble_gatt_server_cbk_packet_handler(uint8_t packet_type, uint16_t channel, uint8_t *packet, uint16_t size)
{
    ...
    case HCI_EVENT_PACKET:
        ...
        case ATT_EVENT_HANDLE_VALUE_INDICATION_COMPLETE:
            ...
            __gatt_server_event_callback_handler(GATT_COMM_EVENT_SERVER_INDICATION_COMPLETE, (u8 *)tmp_val, 4, packet);
            break;
        ...
        case HCI_EVENT_LE_META:
            ...
            case HCI_SUBEVENT_LE_CONNECTION_COMPLETE: {
                if (BT_OP_SUCCESS != packet[3]) {
                    ...
                    case BT_ERR_ADVERTISING_TIMEOUT:
                        log_info("DIRECT_ADV TO!\n");
                        __gatt_server_set_work_state(INVAIL_CONN_HANDLE, BLE_ST_IDLE, 1);
                        __gatt_server_event_callback_handler(GATT_COMM_EVENT_DIRECT_ADV_TIMEOUT, (u8 *)tmp_val, 2, packet);
                        break;

                    default:
                        log_info("CONNECTION FAIL!!! %0x\n", packet[3]);
                        __gatt_server_set_work_state(INVAIL_CONN_HANDLE, BLE_ST_IDLE, 1);
                        __gatt_server_event_callback_handler(GATT_COMM_EVENT_CONNECTION_COMPLETE_FAIL, (u8 *)tmp_val, 2, packet);
                        break;
                    }
                    __gatt_server_check_auto_adv();
                    break;
                ...
                __gatt_server_set_work_state(INVAIL_CONN_HANDLE, BLE_ST_IDLE, 0);
                __gatt_server_event_callback_handler(GATT_COMM_EVENT_CONNECTION_COMPLETE, (u8 *)tmp_val, 2, packet);
            }
            break;
            ...
            case HCI_SUBEVENT_LE_CONNECTION_UPDATE_COMPLETE: {
                ...
                __gatt_server_event_callback_handler(GATT_COMM_EVENT_CONNECTION_UPDATE_COMPLETE, (u8 *)tmp_val, 2, packet);
            }
            break;
            ...
            case HCI_SUBEVENT_LE_DATA_LENGTH_CHANGE:
                ...
                __gatt_server_event_callback_handler(GATT_COMM_EVENT_CONNECTION_DATA_LENGTH_CHANGE, (u8 *)tmp_val, 2, packet);
                break;
            ...
            case HCI_SUBEVENT_LE_PHY_UPDATE_COMPLETE:
                ...
                __gatt_server_event_callback_handler(GATT_COMM_EVENT_CONNECTION_PHY_UPDATE_COMPLETE, (u8 *)tmp_val, 2, packet);
                break;
            }
            break;
        ...
        case HCI_EVENT_DISCONNECTION_COMPLETE: {
            ...
            __gatt_server_event_callback_handler(GATT_COMM_EVENT_DISCONNECT_COMPLETE, (u8 *)tmp_val, 4, packet);
            //配设备开adv
        ...
        case L2CAP_EVENT_CONNECTION_PARAMETER_UPDATE_RESPONSE: {
            ...
            if (__this->server_operation_handle == tmp_val[0]) {
                ...
                __gatt_server_event_callback_handler(GATT_COMM_EVENT_CONNECTION_UPDATE_REQUEST_RESULT, (u8 *)tmp_val, 4, 0);
            }
        }
        break;
        ...
        case HCI_EVENT_ENCRYPTION_CHANGE: {
            ...
            __gatt_server_event_callback_handler(GATT_COMM_EVENT_ENCRYPTION_CHANGE, (u8 *)tmp_val, 4, 0);
        }
        break;
        }
        break;
 ...
 */
/*************************************************************************************************/
static int ble_gatt_server_disconnect_update_conn(void *p)
{
