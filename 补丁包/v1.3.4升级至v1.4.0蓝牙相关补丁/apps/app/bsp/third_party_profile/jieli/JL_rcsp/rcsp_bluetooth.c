...
{
    log_error("JL_rcsp_wait_resp_timeout\n");
    return 0;
}
...
static void rcsp_ble_callback_set(void (*resume)(void), void (*recieve)(void *, void *, u16), void (*status)(void *, u8))
{
    if (__this->rcsp_ble) {
...
{
    //log_info_hexdump(buf, len > 0x20 ? 0x20 : len);
    if (0 == BT_CONNECTION_VERIFY) {
