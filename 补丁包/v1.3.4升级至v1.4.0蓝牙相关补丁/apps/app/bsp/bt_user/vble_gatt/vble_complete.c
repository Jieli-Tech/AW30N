...
vble_attchn_mge vble_slv2mstr_info[] = {
    {.att_handle = ATT_CHARACTERISTIC_HID_2a4d_01_VALUE_HANDLE, .reserved = 0, .callback = NULL},
    {.att_handle = ATT_CHARACTERISTIC_HID_2a4d_02_VALUE_HANDLE, .reserved = 0, .callback = NULL},
    {.att_handle = ATT_CHARACTERISTIC_HID_2a4d_04_VALUE_HANDLE, .reserved = 0, .callback = NULL},
    {.att_handle = ATT_CHARACTERISTIC_HID_2a4d_05_VALUE_HANDLE, .reserved = 0, .callback = NULL},
    {.att_handle = ATT_CHARACTERISTIC_HID_2a4d_06_VALUE_HANDLE, .reserved = 0, .callback = NULL},
    {.att_handle = ATT_CHARACTERISTIC_HID_2a4d_07_VALUE_HANDLE, .reserved = 0, .callback = NULL},
};

vble_attchn_mge vble_mstr2slv_info[] = {
    {.att_handle = ATT_CHARACTERISTIC_HID_2a4d_03_VALUE_HANDLE, .reserved = 0, .callback = NULL},
};
