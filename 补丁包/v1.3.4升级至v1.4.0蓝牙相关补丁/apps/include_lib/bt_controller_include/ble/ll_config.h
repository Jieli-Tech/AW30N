...
extern const int config_bt_only_scan_set;
...
#define LE_FEATURES_IS_ONLY_LE_SCAN()        (config_bt_only_scan_set)
/*-----------------------------------------------------------*/
...
#define LE_SLOT_IS_SUPPORT()                (config_vendor_le_bb)

#define LL_CONN_INTERVAL_US(x)     ((LE_SLOT_IS_SUPPORT() & VENDOR_BB_CONNECT_SLOT) ? (x * 625L) : (x * 1250L))
