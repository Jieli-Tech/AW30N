...
#elif CONFIG_APP_REDUCE_RAM
const uint64_t config_btctler_le_features = 0;
const int config_btctler_le_roles    = (LE_SCAN);
const int config_btctler_le_hw_nums = 1;
const int config_btctler_le_rx_nums = 2;
const int config_btctler_le_acl_packet_length = 27;
const int config_btctler_le_acl_total_nums = 2;
const int config_bt_only_scan_set = 0; //蓝牙仅做扫描,最省ram

const int config_btctler_ble_hw_max_rx_octets = 37;
const int config_btctler_ble_hw_max_tx_octets = 37;
#else
...
const int config_bt_only_scan_set = 1; //蓝牙仅做扫描,最省ram
#endif
...
const int config_btctler_le_clock_accuracy = 150;
