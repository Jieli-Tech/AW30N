...
#define ADC_CH_TYPE_LPCTM  	(0x4<<16)
...
#define ADC_CH_PMU_VLCD_4	    (ADC_CH_TYPE_PMU | 0x2) // 1/4VLCD
#define ADC_CH_PMU_AVDDR_2	    (ADC_CH_TYPE_PMU | 0x3) // 1/2AVDDR
#define ADC_CH_PMU_VTEMP	    (ADC_CH_TYPE_PMU | 0x4)
#define ADC_CH_PMU_VPWR_4 	    (ADC_CH_TYPE_PMU | 0x5) // 1/4VPWR
#define ADC_CH_PMU_AVDDCP_4 	(ADC_CH_TYPE_PMU | 0x6) // 1/4AVDDCP
#define ADC_CH_PMU_AVDDCP_2 	(ADC_CH_TYPE_PMU | 0x7) // 1/2AVDDCP
...
#define ADC_CH_IO_PA4       (ADC_CH_TYPE_IO | 0x0)
#define ADC_CH_IO_PA5       (ADC_CH_TYPE_IO | 0x1)
#define ADC_CH_IO_PA8       (ADC_CH_TYPE_IO | 0x2)
#define ADC_CH_IO_PA13      (ADC_CH_TYPE_IO | 0x3)
#define ADC_CH_IO_PA14      (ADC_CH_TYPE_IO | 0x4)
