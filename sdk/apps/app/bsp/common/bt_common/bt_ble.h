...
#if (RUN_APP_CUSTOM)
#define TESTE_BLE_EN                1//ble_test demo
#define TRANS_DATA_HID_EN           0//数传demo
#define TRANS_DATA_SPPLE_EN         0//数传demo
#elif (RUN_APP_RC)
#define TESTE_BLE_EN                0//ble_test demo
#define TRANS_DATA_HID_EN           1//数传demo
#define TRANS_DATA_SPPLE_EN         0//数传demo
#elif (RUN_APP_DONGLE)
#define TESTE_BLE_EN                0//ble_test demo
#define TRANS_DATA_HID_EN           0//数传demo
#define TRANS_DATA_SPPLE_EN         1//数传demo
#endif
...
typedef struct _vble_smpl_role_ops {
    ...
    void (*recv_cb_register)(int (*cb_func)(u8 *, u16));
    void (*module_enable)(u8 en);
    void (*adv_enable)(u8 enable);
    void (*profile_init)(void);
    u32(*get_ble_status)(void);
    u32(*update_conn_interval)(u16 interval);
} vble_smpl_role_ops;
